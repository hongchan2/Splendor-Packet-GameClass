    ...
    */
    ...
    public class Board
    {
        ...
        public void CardInit()
        {
            ...
            deckCards1.Add(new Card(cardID++, 2, 0, 0, 0, 1, 0, 1, 1)); // 9
            ...
            deckCards1.Add(new Card(cardID++, 0, 1, 0, 0, 2, 0, 1, 2)); // 17
            ...
            deckCards1.Add(new Card(cardID++, 0, 0, 0, 0, 3, 0, 1, 3)); // 25
            ...
            deckCards1.Add(new Card(cardID++, 1, 2, 2, 0, 0, 0, 1, 4)); // 33
            ...
            // Level 2
            deckCards2.Add(new Card(cardID++, 0, 2, 2, 0, 3, 1, 2, 0)); // 41
            ...
            deckCards2.Add(new Card(cardID++, 6, 0, 0, 0, 0, 3, 2, 0)); //46
            ...
            deckCards2.Add(new Card(cardID++, 0, 6, 0, 0, 0, 3, 2, 1)); // 52
            ...
            deckCards2.Add(new Card(cardID++, 0, 0, 6, 0, 0, 3, 2, 2)); //58
            ...
            deckCards2.Add(new Card(cardID++, 0, 0, 0, 6, 0, 3, 2, 3)); //64
            ...
            deckCards2.Add(new Card(cardID++, 0, 0, 0, 0, 6, 3, 2, 4)); //70
            ...
            deckCards3.Add(new Card(cardID++, 3, 0, 0, 7, 0, 5, 3, 0)); //74
            ...
            deckCards3.Add(new Card(cardID++, 0, 3, 0, 0, 7, 5, 3, 1)); //78
            ...
            deckCards3.Add(new Card(cardID++, 0, 7, 3, 0, 0, 5, 3, 2)); //82
            ...
            deckCards3.Add(new Card(cardID++, 0, 0, 7, 3, 0, 5, 3, 3)); //86
            ...
            deckCards3.Add(new Card(cardID++, 7, 0, 0, 0, 3, 5, 3, 4)); //90

            deckNoble.Add(new Noble(cardID++, 0, 0, 4, 4, 0));  // 91 ~ 100
